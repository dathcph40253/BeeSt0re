            ...
            <c:if test="${user.role != 'Guest'}">
                ...
                <div class="dropdown-container">
                    ...
                    <div class="menu-dropdown">
                        ...
                        <a href="/BeeStore/MauSac" class="menu-dropdown-item">
                            ...
                            <div class="action-card">
                                ...
                                <div class="dropdown mt-2">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownQuanLySP">
                                        <li><a class="dropdown-item" href="/BeeStore/Products/manage">Danh sách sản phẩm</a></li>
                            ...
                            <div class="action-card">
                                ...
                                <div class="dropdown mt-2">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMauSac">
                                        <li><a class="dropdown-item" href="/BeeStore/MauSac">Danh sách màu sắc</a></li>
<%--                                        <li><a class="dropdown-item" href="#">Thêm màu sắc mới</a></li>--%>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="action-card">
                                ...
                                <div class="dropdown mt-2">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownChatLieu">
                                        <li><a class="dropdown-item" href="#">Danh sách chất liệu</a></li>
                            ...
                            <div class="action-card">
                                ...
                                <div class="dropdown mt-2">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownKichCo">
                                        <li><a class="dropdown-item" href="#">Danh sách kích cỡ</a></li>
                            ...
                            <div class="action-card">
                                ...
                                <div class="dropdown mt-2">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownNhanHang">
                                        <li><a class="dropdown-item" href="#">Danh sách nhãn hàng</a></li>
                                ...
                                <div class="action-card">
                                    ...
                                    <div class="dropdown mt-2">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownKhuyenMai">
                                            <li><a class="dropdown-item" href="#">Danh sách khuyến mãi</a></li>
