...
<footer class="site-footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-section">
                    ...
                    <div class="footer-content">
                        <p><strong>Hệ thống Mua bán Trực tuyến BeeStore</strong></p>
                        <p>Công ty TNHH FPT IS, GPĐKKD số 0104128565 do Sở KHĐT TP Hà Nội cấp ngày 13/08/2009</p>
                        <p><i class="fas fa-map-marker-alt"></i>Tòa FPT, số 10 Phạm Văn Bạch, Phường Dịch Vọng, Quận Cầu Giấy, Hà Nội, Việt Nam</p>
                        <p><i class="fas fa-phone"></i>Hỗ trợ trực tuyến: 1900 636 111 hoặc 0353055060 (8h30 - 21h từ thứ 2 - thứ 6, 8h30 - 11h30 thứ 7)</p>
                        <p><i class="fas fa-envelope"></i>cskh@beestore.com.vn</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-section">
                    <h5 class="footer-title">Về BeeStore</h5>
                    <div class="footer-content">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-section">
                    <h5 class="footer-title">Kết nối với BeeStore</h5>
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="text-center">
                <p>&copy; Copyright 2024 Furniture BeeStore. All Rights Reserved. MS: 0324804526</p>
            </div>
        </div>
    </div>
</footer>
