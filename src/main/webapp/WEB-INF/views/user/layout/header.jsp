...
<div class="info-bar">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            <div>
                <a href="tel:1900636111"><i class="fas fa-phone"></i>1900.636.111</a>
                <a href="tel:0353055060"><i class="fas fa-phone"></i>0353.055.060</a>
                <a href="mailto:support@vio.edu.vn"><i class="fas fa-envelope"></i>support@vio.edu.vn</a>
            </div>
            <div>
                <a href="#"><i class="fab fa-facebook"></i>Facebook VioEdu</a>
            </div>
        </div>
    </div>
</div>
