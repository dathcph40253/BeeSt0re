    ...
    <div class="banner-with-sidebar">
        ...
        <div class="sidebar-menu">
            <ul class="menu-list">
                ...
                <li><a href="/product?categoryId=5"><i class="fa fa-laptop"></i> Điện tử</a></li>
                <li><a href="/product?categoryId=6"><i class="fa fa-home"></i> Đồ gia dụng</a></li>
                <li><a href="/product?categoryId=7"><i class="fa fa-paw"></i> Thú cưng</a></li>
